        ...
        <div class="container">
            <div class="columns">
                <div class="column is-one-fifth-desktop is-one-tenth-tablet is-one-tenth-fullhd">
                    <figure class="image">
                        <img class="is-rounded" src="https://montanastorytelling.github.io/alice-lesson-plans-pd/assets/images/brad.jpg" alt="{{site.author-name}}" width="10%" height=5%>
                    </figure>
                    <p>Brad</p>
                </div>
                <div class="column is-one-tenth-desktop is-one-tenth-tablet is-one-tenth-fullhd">
                    <figure class="image">
                        <img class="is-rounded" src="https://montanastorytelling.github.io/alice-lesson-plans-pd/assets/images/jake.jpg" alt="{{site.author-name}}">
                    </figure>
                    <p>Jake</p>
                </div>
                <div class="column is-one-tenth-desktop is-one-tenth-tablet is-one-tenth-fullhd">
                    <figure class="image">
                        <img class="is-rounded" src="{{https://montanastorytelling.github.io/alice-lesson-plans-pd/assets/images/olivia.jpg}}" alt="{{site.author-name}}">
                    </figure>
                    <p>Olivia</p>
                </div>
                <div class="column is-one-tenth-desktop is-one-tenth-tablet is-one-tenth-fullhd">
                    <figure class="image">
                        <img class="is-rounded" src="{{https://montanastorytelling.github.io/alice-lesson-plans-pd/assets/images/suzie.jpg}}" alt="{{site.author-name}}">
                    </figure>
                    <p>Suzie</p>
                </div>
                <div class="column is-one-tenth-desktop is-one-tenth-tablet is-one-tenth-fullhd">
                    <figure class="image">
                        <img class="is-rounded" src="{{https://montanastorytelling.github.io/alice-lesson-plans-pd/assets/images/eli.jpg}}" alt="{{site.author-name}}">
                    </figure>
                    <p>Eli</p>
                </div>
                <div class="column is-one-tenth-desktop is-one-tenth-tablet is-one-tenth-fullhd">
                    <figure class="image">
                        <img class="is-rounded" src="{{https://montanastorytelling.github.io/alice-lesson-plans-pd/assets/images/brittany.jpg}}" alt="{{site.author-name}}">
                    </figure>
                    <p>Brittany</p>
                </div>
                <div class="column is-one-tenth-desktop is-one-tenth-tablet is-one-tenth-fullhd">
                    <figure class="image">
                        <img class="is-rounded" src="{{https://montanastorytelling.github.io/alice-lesson-plans-pd/assets/images/stacey.jpg}}" alt="{{site.author-name}}">
                    </figure>
                    <p>Stacey</p>
                </div>
            </div>
